"Loading montes.m";
  ...
  return PolToFieldElt(P`Parent,lftnum)/(P`IntegerGenerator^lftden);
  end intrinsic;
  ...
  return OMreps,TreesIntervals,totalindex,fa; /////////////////////////////////// Added fa - Pauli
  end intrinsic;
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  K`PrimeIdeals[p],TreesIntervals,totalindex,residualfacs:=Montes(Pol,p: NumberField:=true); /////////////////////////////////// Added residualfacs - Pauli
  Psi:=0;
  logLG:=0;
  pos:=1;
...
/////////////////////////////////// Added - Pauli
	PType:=K`PrimeIdeals[p,i]`Type;
	K`PrimeIdeals[p,i]`PSI:=MinimalPolynomial(PType[#PType]`Fq.1);  
 /////////////////////////////////// Added - Pauli
